...
The individual measurements of these processes are all $\sim2$-3 standard deviations from the SM predictions however, combining the results from different decays and experiments increases the difference. The combined results of different $b \to sll$ transitions are 4-5 standard deviations from the SM predictions~\cite{Altmannshofer:2017yso,Capdevila:2017bsm} and the combined values of $R(D)$ and $R(D^*)$ measurements from different experiments are $\sim 3.9$ standard deviations from the SM predictions~\cite{Amhis:2016xyh}.  
