...
\ifsetCustomMargin
%  \RequirePackage[left=30mm,right=20mm,top=30mm,bottom=20mm]{geometry} %This is what the binders recommend, I think it's not great
  \RequirePackage[left=35mm,right=25mm,top=35mm,bottom=20mm]{geometry}    
...
\newcommand{\barbsd}{$\overline{B}_{(s)}^{0}$\xspace}
\newcommand{\barbs}{$\overline{B}_{s}^{0}$\xspace}
\newcommand{\barbd}{$\overline{B}^{0}$\xspace}
...
\newcommand{\chiFD}{$\chi^{2}_{\mathrm{FD}}$\xspace}
\newcommand{\chiIP}{$\chi^{2}_{\mathrm{IP}}$\xspace}
\newcommand{\chivtx}{$\chi^{2}_{\mathrm{VTX}}$\xspace}
\newcommand{\chitrk}{$\chi^{2}_{\mathrm{trk}}$\xspace}
