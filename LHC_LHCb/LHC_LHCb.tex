...
\begin{tabular}{lllll}
\hline
\multirow{2}{c}{Run} & \multirow{2}{c}{Year} & \multirow{2}{c}{$\sqrt{s}$ / \tev} & \multicolumn{3}{c}{Integrated luminosity / \fb}\\ 
\cline{4-5}
    &     &                             & ATLAS &  CMS       & LHCb \\ \hline
 \multirow{3}{c}{Run 1}    & 2010 & 7   & 0.04  & 0.04        & 0.04\\
     & 2011 & 7                         & 5.08  & 5.55      &  1.11 \\
    & 2012 & 8                          & 21.3  & 21.79  &  2.08 \\ \hline
\multirow{2}{c}{Run 2}    & 2015 & 13   & 3.9   & 3.81 &        & 0.32\\
...
The cylindrical geometery used for the VELO sensors, shown in Figure~\ref{fig:velo_sensor}, is chosen to allow fast reconstruction of particle trajectories in the VELO.
...
\begin{figure}[tb] 
  ...
  \caption{Illustration of the relative sizes of the tracking stations. The TT is in purple on the left hand side of the diagram, the IT is in purple surrounded in turquise by the OT and the beam pipe is shown in red~\cite{Alves:2008zz}.}
...
The data collected by the LHCb experiment during $pp$ collisions is summaried in Figure~\ref{fig:LHCb_lumi}. The physics analyses described in this dissertation use an integrated luminoscity of 4.4~\fb which consists of data recorded during 2011, 2012 and 2015 and up until September of 2016. The intergrated luminosities used for each year are given in Table~\ref{}. The integrated luminosity of Run~2 is currently less that the total from Run~1, however the production cross section for \bhadrons approximately doubled with the increase in centre-of-mass energy between Run~1 and Run~2 therefore the Run~2 data set will already contain more \bhadrons useful for physics analyses than the Run~1 data set. 
...
Run & Year & Integrated luminosity / \fb\\ 
 \multirow{3}{c}{Run 1}    & 2010 & 7          & 0.04\\
     & 2011 & 7                             &  1.11 \\
    & 2012 & 8                         &  2.08 \\ \hline
\multirow{2}{c}{Run 2}    & 2015 & 13           & 0.32\\
    & 2016 & 13                                & 1.10     \\ \hline
