...
\label{LHCb}
The LHCb experiment was build to study the SM and search for new physics phenomena through the study of $\mathcal{CP}$-violating decays and rare $b$-hadron decays. 
...
At the LHC the dominant production mechanisms of \bbbar pairs are gluon-gluon fusion, quark anti-quark annihilation and gluon-gluon splitting, illustrated in Figure~\ref{}. The \bbbar pairs produced travel at small angles relative to the beam pipe as shown in Figure~\ref{fig:bbar_production} and hadronize to form a range of \bhadrons, including $B^{+}$, $B^{0}_{s}$ and $\Lambda^{0}_{b}$, that are studied by LHCb. 
\begin{figure}[tb]
  \centering
  \includegraphics[ width=0.45\textwidth]{./Figs/LHC_LHCb/bbbar_prod_1.pdf}
  \includegraphics[ width=0.45\textwidth]{./Figs/LHC_LHCb/bbbar_prod_2.pdf}
  \includegraphics[ width=0.45\textwidth]{./Figs/LHC_LHCb/bbbar_prod_3.pdf}

  \caption{Feynman disgrams for $b\bar{b}$ production at LHCb.}
 \label{fig:bbar_productionA}
\end{figure}
...
Excellent vertex resolution is required in the VELO, to achieve this the sensor need to be as close as possible to the interaction point. This is achieved by making the VELO out of two retractable halves and including the $pp$ interaction point within the coverage of the VELO. 
