...
\begin{figure}[tb]
  ...
  \caption{RICH-1 detector (left) and the RICH-2 detector (right)~\cite{Alves:2008zz}. For Run 2 the aerogel radiator in the RICH-1 detector \
was removed. }%Both RICH detectors use HPDs to detect light from Cheren that are sensitive to magnetic fields, the HPDs are shielded from the\
 magnet field using iron sheets ensuring the field is less than 2mT across them. This allows accurate detection of light created within the R\
ICH detectors.                                                                                                                                
