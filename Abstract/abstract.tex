...
This dissertation documents a study of very rare B meson decays at the LHCb experiment using data taken during the first two experiment runs of the Large Hadron Collider (LHC).
...
The branching fractions of the very rare \bmumu decays and the effective lifetime of \bsmumu decays are sensitive to effects from new physics. 
...
The $B_{s}^{0} \to \mu^{+} \mu^{-}$ decay is observed with a statistical significance of 7.8$\sigma$ and the branching fraction is measured to be $\mathcal{B}(B_{s}^{0} \to \mu^{+} \mu^{-}) = (3.0 \pm 0.6^{+0.3}_{-0.2}) \times 10^{-9}$. The $B_{s}^{0} \to \mu^{+} \mu^{-}$ effective lifetime is measured for the first time as 2.04 $\pm$ 0.44 (stat) $\pm$ 0.05 (syst)~\ps.
