...
The \bsmumu \el can be measured by fitting a single exponential to the same set of decays used to measure the \BF~\cite{DeBruyn:2012wj}. The LHCb experiment has measured the effective lifetimes of several \bs decays in this way. The measurements are summarised in Table~\ref{tab:taueffmeasurements} where the measured values are given alongside the SM predictions for \ADG and for the effective lifetimes. %These measurements include the \bskpi effective lifetime~\cite{Aaij:2014fia} in which equal proportions of the heavy and light \bs mass eigenstates contribute to the decay in the SM and the \bskk and $B^{0}_{s} \to D^{-}_{s} D^{+}_{s}$ effective lifetimes~\cite{Aaij:2014fia,Aaij:1463886, Aaij:2013bvd} where the light \bs mass eigenstate decays into the $K^{+}K^{-}$ and $D^{-}_{s} D^{+}_{s}$ final states in the SM. 
...
\toprule                                                                                                                                                                                                   
\toprule           
%Decay & A$_{\Delta\Gamma}$ SM prediction & $\tau$ SM prediction /\ps & Measured $\tau$ /\ps \\ 
Decay &Predicted \ADG&Predicted  $\tau$ /\ps &Measured $\tau$ /\ps\\
%      & of \ADG      & of $\tau$ /\ps & \\
\midrule
$B^{0}_{s} \to J/\psi f_{0}(980)$ & $+1$ & $1.609 \pm 0.11$ & $1.700 \pm 0.040 \pm 0.026$ \\
$B^{0}_{s} \to J/\psi K^{0}_{S}$ &$0.94 \pm 0.07$ & $1.605 \pm 0.11$ & $1.75 \pm 0.12 \pm 0.07$ \\
\bskpi & 0 & $1.518 \pm 0.005$ &$1.60 \pm 0.06 \pm 0.01$ \\ 
\bskk & $-0.972^{+0.014}_{-0.009}$ & $1.416 \pm 0.008$ &$1.407 \pm 0.016 \pm 0.007$ \\
$B^{0}_{s} \to D^{-}_{s} D^{+}_{s}$ & $-1$ & $1.413 \pm 0.008$& $1.379 \pm 0.026 \pm 0.017$ \\ 
%$B^{0}_{s} \to J/\psi f_{0}(980)$ & $+1$ & $1.609 \pm 0.11$ & $1.700 \pm 0.040 \pm 0.026$ \\
%$B^{0}_{s} \to J/\psi K^{0}_{S}$ &$0.94 \pm 0.07$ & $1.605 \pm 0.11$ & $1.75 \pm 0.12 \pm 0.07$ \\
\bottomrule                                                                                                                                                                                                
\bottomrule                                                                                                                                                                                                
\end{tabular}%                                                                                                                                                                                             
\vspace{0.7cm}                                                                                                                                                                                             
\caption{SM predictions for \ADG and the predicted and measured values of the effective lifetimes for \bs decays measured by the LHCb experiment. The effective lifetimes have been measured for $B^{0}_{s} \to J/\psi f_{0}(980)$~\cite{Aaij:2012nta}, $B^{0}_{s} \to J/\psi K^{0}_{S}$~\cite{Aaij:2013eia},  \bskpi~\cite{Aaij:2014fia}, \bskk~\cite{Aaij:2014fia} and $B^{0}_{s} \to D^{-}_{s} D^{+}_{s}$~\cite{Aaij:2013bvd} decays. The quoted \ADG values are taken from the listed references and the predictions for effective lifetimes are computed using Equation~\ref{eq:lifetimedef} with $\tau_{B_{s}} = 1.505 \pm 0.005$~ps~\cite{Amhis:2016xyh} and $y_{s} = 0.065 \pm 0.005$~\cite{Olive:2016xmw}. The deviation from $-1$ and $+1$ for the \ADG value of \bskk and $B^{0}_{s} \to J/\psi K^{0}_{S}$ decays, respectively, comes from $\mathcal{CP}$ violation in these processes.  }
\label{tab:taueffmeasurements}                                                                                                                                                                       
\end{center}                                                                                                                                                                                               
\vspace{-1.0cm}                                                                                                                                                                                            
\end{table} 
