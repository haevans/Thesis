...
\documentclass[a4paper,12pt,default,numbered,index,draft]{Classes/PhDThesisPSnPDF}
%\usepackage{lineno}
%\linenumbers
%NOTE---------------------------------------------------------------------------
...
% ******************************** Front Matter ********************************
\begin{document}
%uncomment line below for full draft
\frontmatter
...
%Uncomment all lines below for full draft
%\include{./title/title}
