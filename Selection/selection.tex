...
\begin{figure}
   ...
   % \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[0.8 width=\textwidth]{./Figs/Selection/CMSLHCb_fig2.pdf}
        %\caption{ }
       % \label{fig:BDTSsig}
    %\end{subfigure}
...
\end{tabular}
\vspace{0.7cm}
\caption{Stripping line efficiencies for \bsmumu, \bhh and \bujpsik  2012 simulated decays. Selection cuts applied are listed in Table~\ref{tab:PreviousStripping}.  }
...
\end{tabular}
\end{center}
\label{tab:effandretention}
\vspace{0.7cm}
\caption{The efficiency of the \bmumu stripping line to select \bsmumu decays and the changing in the date retention for \bmumu, \bhh and \bujpsik stripping lines for a range of FD \chisqd and daughter IP \chisqd cut values.}
\end{table}
\vspace*{\fill}
\end{landscape}
}
