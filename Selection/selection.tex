...
\end{tabular}
\vspace{0.7cm}
\caption{Signal efficiencies of \bmumu, \bhh and \bujpsik stripping lines using simulated \bmumu, \bdkpi and \bujpsik decays, respectively. The stripping selection cuts are lised in Tables~\ref{tab:PreviousStrippingA} and~\ref{tab:PreviousStrippingB} and efficiencies are evaluted only for cuts are shared between all stripping lines.}%n the \bsmumu stripping, each cut separately and the total efficiencies are given for the listed cuts and the complete set of cuts present in each stripping line. }
...
\begin{table}[htbp]
\begin{center}
\begin{tabular}{ ccrrrrr}\toprule \toprule
...
%Hlt1Phys       & Dec \\                                                            
%Hlt2Phys       & Dec \\ \midrule                                                     
\multicolumn{2}{c}{{\it \bsmumu decays}} \\ \midrule
L0Global        & TIS or TOS \\
Hlt1Phys        & TIS or TOS \\
Hlt2Phys        & TIS or TOS \\ \midrule
\multicolumn{2}{c}{{\it \bhh decays}} \\ \midrule
L0Global        & TIS\\
Hlt1Phys        & TIS \\
...
\begin{tabular}{lr}
\toprule \toprule
BDT cut & $\lambda$ /c$^{2}$MeV$^{-1}$\\ \midrule
...
0.65            & 4.65 & 0.309 & 0.115 \\  \bottomrule \bottomrule%&  $-0.01 \pm 0.01$  & $1.000 \pm 0.007$ \\ \hline
\end{tabular} 
\vspace{0.7cm}
