...
\subsection{Summary}
\label{sec:BFsummary}
The complete set of selection criteria used for identify \bmumu decays in Run~1 and Run~2 data for the \BF mesaurements are listed in Tables~\ref{tab:BFfullselection}. % ands~\ref{} alongside the selection for \bhh, \bujpsik and \bsjpsiphi decays.
