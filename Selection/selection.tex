...
\end{tabular}
\vspace{0.7cm}
\caption{Branching fractions for background decays.}% The measured values of \bhh, \bdpimunu and \lambdab are taken from references~\cite{Olive:2016xmw,Aaij:2015bfa}. The theoritcal prediction for \bsKmunu \BF combined information from references~\cite{Bouchard:2014ypa,PhysRevD.91.074510}, the  \bcjpsimunu \BF is estimated from references~\cite{Aaij:2012dd,Aaij:2014jxa} and the \bdpimumu and \bupimumu \BFs are obtained from~\cite{Aaij:2015nea,Wang:2012ab}   }
