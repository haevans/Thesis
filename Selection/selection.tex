...
\item \bhh decays, where $ h  = K, \pi$, where both hadrons are mis-identified as muons. This usually occurs when the hadrons decay in flight. Similarly to mis-identified semi-leptonic decays the reconstructed \bs candidate mass is lower than expected. The mass distribution of these backgrounds are illustrates in Figure~\ref{fig:LHCbCMS} as peaking backgrounds.
...
\begin{figure}
   ...
   % \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[width=\textwidth]{./Figs/Selection/CMSLHCb_fig2.pdf}
        %\caption{ }
       % \label{fig:BDTSsig}
    %\end{subfigure}
   ...
   % \begin{subfigure}[b]{0.4\textwidth}
     ...
     %   \label{fig:BDTSbkg}
  %  \end{subfigure}
    \caption{Dimuon invariant mass spectrum from combined analysis of CMS and LHCb data sets for \bmumu Branching Fraction measurements~\cite{CMS:2014xfa}. }
    \label{fig:LHCbCMS}
\end{figure}
