void FitPlots()///Bd2KPi_BDT1_n_bd_S21_Data_Both_Both_BinningBHH_PIDsWeight_B2HH_Hlt2TOS_NoWeight_NoExclBkg_BDT_TrigCorr_DatavsMC_PubPlot()
{
//=========Macro generated from canvas: c_fit/c_fit
//=========  (Wed Jan 25 13:24:08 2017) by ROOT version6.02/05
   ...
   Graph_Graph3001->SetMinimum(1.846492e-05);
   Graph_Graph3001->SetMaximum(0.4364952);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","LHCb Run I","h");
