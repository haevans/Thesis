...
The number of mis-identified \bhh decays expected in each BDT bin after the \bmumu selection is calculated by multiplying the total number of mis-identified \bhh decays with the mis-identification probability for each BDT bin and correcting for the different trigger efficiencies used to select \bdkpi and \bmumu decays, as shown in Equation~\ref{eq:bhhprediction}. 
